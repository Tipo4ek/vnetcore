...
This mechanism has been integrated into Bitcore-Node-VNet which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/vnet/insight-api-vnet#web-socket-api](https://github.com/vnet/insight-api-vnet#web-socket-api)
* API: [https://github.com/vnet/insight-api-vnet#instantsend-transactions](https://github.com/vnet/insight-api-vnet#instantsend-transactions)
...
By default, the VNet Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the VNet Core daemon:
