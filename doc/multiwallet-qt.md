...
Only requiring some minor changes is vnet.cpp.
...
Changes to vnet.cpp
----------------------
vnet.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
