 ...
 *
 *   // network
 *   CVNETNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CVNETNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: VNETNetwork
// //   -- signature requirements : Key1(User)
// class CVNETNetworkVariable : public CGovernanceObject
// {
// private:
