    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("VNet Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a VNet address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and vnet: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About VNet Core"), this);
    aboutAction->setStatusTip(tr("Show information about VNet Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for VNet Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your VNet addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified VNet addresses"));
    ...
    openAction->setStatusTip(tr("Open a vnet: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the VNet Core help message to get a list with possible VNet Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("VNet Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to VNet network", "", count));
    } else {
...
{
    QString strTitle = tr("VNet Core"); // default title
