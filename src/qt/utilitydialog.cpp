    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("VNet Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About VNet Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  vnet-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the VNet in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 VNET, 0.1 VNET, 1 VNET and 10 VNET -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("VNet Core is shutting down...") + "<br /><br />" +
